...
var transportations = ["Honda Motorcycle", "Suzuki Cultus", "Toyota Corolla", "Honda Civic"];
transportations.map(function (index) { return console.log("I would like to own a ".concat(index)); });
